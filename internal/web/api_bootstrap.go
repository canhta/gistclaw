...
func (s *Server) handleBootstrap(w http.ResponseWriter, r *http.Request) {
	...
	writeJSON(w, http.StatusOK, bootstrapResponse{
		...
		Navigation: []bootstrapNavItem{
			{ID: "chat", Label: "Chat", Href: pageChat},
			{ID: "channels", Label: "Channels", Href: pageChannels},
			{ID: "instances", Label: "Instances", Href: pageInstances},
			{ID: "sessions", Label: "Sessions", Href: pageSessions},
			{ID: "cron", Label: "Cron Jobs", Href: pageCron},
			{ID: "skills", Label: "Skills", Href: pageSkills},
			{ID: "nodes", Label: "Nodes", Href: pageNodes},
			{ID: "approvals", Label: "Exec Approvals", Href: pageApprovals},
			{ID: "config", Label: "Config", Href: pageConfig},
			{ID: "debug", Label: "Debug", Href: pageDebug},
			{ID: "logs", Label: "Logs", Href: pageLogs},
			{ID: "update", Label: "Update", Href: pageUpdate},
		},
	})
}
