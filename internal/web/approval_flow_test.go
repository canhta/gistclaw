...
func TestApprovalFlow_LegacyRunDismissRouteUnavailable(t *testing.T) {
	h := newServerHarness(t)
	...
	if rr.Code != http.StatusNotFound {
		t.Fatalf("expected legacy dismiss route to be removed, got %d body=%s", rr.Code, rr.Body.String())
	}
}
